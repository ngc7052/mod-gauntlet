...
| S7 | Rank II and rank III differ from rank I in the way the entry says, and `.gauntlet status` says so too |
...
Rises every 15 / 10 / 7 min and hunts you. Health 1× / 1⅓× / 1⅔× yours.
...
Every 30th / 25th / 18th kill returns as an echo of you.
...
Every 5th / 4th / 3rd corpse looted draws a pack of 2 / 2 / 3.
...
A fight past 45 / 30 / 20 s draws another enemy every 15 / 15 / 10 s, up to
2 / 3 / 4.
...
Standing still out of combat for 30 / 20 / 12 s attracts an ambusher.
...
Every 10th / 8th / 6th fight opens against a Champion with 2× / 2.5× / 3× health.
...
Enemies flee at 20% / 25% / 35% health and fetch 1 / 1 / 2 friends.
...
A kill alerts kin within 20 / 30 / 40 yd; 1 / 1 / 2 answer.
...
Corpses burst 2 s after death for 8% / 12% / 18%, within 5 yd.
...
A ghost on each corpse drains 2% / 3% / 5%.
...
Melee enemies kick your cast every 15 / 12 / 8 s, locking the school for
2 / 3 / 4 s.
...
Every 25 / 20 / 15 s in combat the sky marks your spot; three seconds later it
lands for 25% / 35% / 50%.
...
Kills within 8 s stack +4% / +6% / +8% damage taken.
...
Each attacker past the first adds 15% / 20% / 30% damage taken.
...
Every 60 / 45 / 30 s in combat your hands fail for 2 / 3 / 4 s.
- Exclusive with Cunning (`roletax`).

**T5 · Hubris** (`hubris`, 18) · tiers 1–50
Enemies below your level give 50% / 25% / 0% experience; above give
+20% / +30% / +40%.
...
30% / 40% / 50% of damage taken becomes a wound that only rest heals.
...
A killing blow leaves you at 1 health instead, once every 1 / 2 / 3 levels.
...
**C1 · Red Mist** (`c01_red_mist`, 28) · rage 100 / 90 / 80
...
**C2 · Berserker's Bargain** (`c02_berserkers_bargain`, 29) · line 30% / 35% / 40%
...
**C3 · Iron Discipline** (`c03_iron_discipline`, 30) · 6 / 10 / 20 s
...
**C4 · Deafening Roar** (`c04_deafening_roar`, 31) · 20 / 30 / 40 yd
...
**C5 · Long Forbearance** (`c05_long_forbearance`, 32) · 2 / 3 / 5 min
...
**C6 · Consecrated Ground** (`c06_consecrated_ground`, 33) · ×1.15 / ×1.25 / ×1.40
...
**C7 · No Sanctuary** (`c07_no_sanctuary`, 34)
...
**C8 · Commitment** (`c08_commitment`, 35) · 3 / 4 / 6 s
...
**C9 · Half-Tamed** (`c09_half_tamed`, 36) · turns at unhappy / unhappy / content
Hostile for 15 / 15 / 25 s.
...
**C10 · Dead Weight** (`c10_dead_weight`, 37) · 3 min / 5 min / never
Feign Death's cooldown. Rank III denies it outright.
- `PermanentCooldown` — the button must go grey.

**C11 · Wide Dead Zone** (`c11_wide_dead_zone`, 38) · 8 / 10 / 15 yd
...
**C12 · Blood Bond** (`c12_blood_bond`, 39) · 20% / 30% / 40%
...
**C13 · Cold Trail** (`c13_cold_trail`, 40) · 10 min / 30 min / never
...
**C14 · Poisoned Blades** (`c14_poisoned_blades`, 41) · 25% / 35% / 50%
...
**C15 · Exposed Back** (`c15_exposed_back`, 42) · ×1.30 / ×1.50 / ×1.75
...
**C16 · Slow Hands** (`c16_slow_hands`, 43) · half / none / none
...
**C20 · Whispers of the Deep** (`c20_whispers_of_the_deep`, 47) · 15% / 20% / 30%
...
**C21 · Rune-starved** (`c21_rune_starved`, 48) · ×1.20 / ×1.30 / ×1.40
...
**C22 · Grave Call** (`c22_grave_call`, 49) · 8 / 5 / 3 s to claim
...
**C23 · Cold Presence** (`c23_cold_presence`, 50) · 6 / 10 / 20 s
...
**C28 · Spirit Debt** (`c28_spirit_debt`, 55) · 2% / 3% / 4%
...
**C29 · Cold Feet** (`c29_cold_feet`, 56) · 15% / 25% / denied
...
**C32 · Arcane Frailty** (`c32_arcane_frailty`, 59) · health ×0.80 / ×0.70 / ×0.60, damage +20% / +30% / +40%
...
**C33 · Fel Pact** (`c33_fel_pact`, 60) · 20 / 15 / 10 kills
...
**C34 · Affliction of the Self** (`c34_affliction_of_the_self`, 61) · 20% / 30% / 40%
Your curses and corruption tick on you too.
- Uses `OnPeriodicTick`. Apply Corruption and stand still.

**C35 · Shard Economy** (`c35_shard_economy`, 62) · shards drop only from level −2 / +0 / +1 and up
...
**C36 · Shared Blood** (`c36_shared_blood`, 63) · ×1.15 / ×1.25 / ×1.40 taken
And the demon deals 40% more.
- Dismiss the demon: the penalty must lift. Re-summon: it must come back.

### Druid

**C37 · Bound Skin** (`c37_bound_skin`, 64) · 4 / 6 / 10 s
...
**C38 · Nature's Toll** (`c38_natures_toll`, 65) · 2% / 3% / 4%
...
**C41 · Faint** (`c41_faint`, 68) · 2 / 3 / 4 s
