...
P.PROTOCOL_VERSION = 16   -- must match Gauntlet::GeneratorVersion (src/Gauntlet.h) and Data.lua's version field
...
callbacks["PACE"]   = function(timed, budgetPct, minSpacingSecs) end   -- timer stretch (Panel.lua)
callbacks["TOTALS"] = function(taken, done, heal, maxhp, speed, xp, gold) end  -- what the set adds up to (Panel.lua)
